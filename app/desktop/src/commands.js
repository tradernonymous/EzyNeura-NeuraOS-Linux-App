...
(function (root, factory) {
  ...
  var COMMANDS = [
    ...
    { id: 'toggle-history', group: 'Panel', title: 'Sidebar (projects and history)', hint: 'Show or hide the left column', keys: 'Ctrl+B' },
    { id: 'go-activity', group: 'Go to', title: 'Runs', hint: 'What ran, and what is waiting on you', palette: 'activity' },
