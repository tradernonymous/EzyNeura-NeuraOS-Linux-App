...
echo "Users add:"
echo "  sudo install -m 0644 <(curl -fsSL https://tradernonymous.github.io/EzyNeura-NeuraOS-Linux-App/neuraos.gpg) /etc/apt/keyrings/neuraos.gpg"
echo "  echo 'deb [signed-by=/etc/apt/keyrings/neuraos.gpg] https://tradernonymous.github.io/EzyNeura-NeuraOS-Linux-App $SUITE $COMP' | sudo tee /etc/apt/sources.list.d/neuraos.list"
echo "  sudo apt update && sudo apt install neura-os-desktop"
